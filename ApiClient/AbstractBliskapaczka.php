...
use Sendit\Bliskapaczka\ApiClient\ApiCaller\ApiCaller;
use Sendit\Bliskapaczka\ApiClient\Mappers\Order;
...
abstract class AbstractBliskapaczka
{
    ...
    */
    ...
    {
        // Sendit\Bliskapaczka\ApiClient\Bliskapaczka\Order
        $className = get_class($this);
        $validatorName = str_replace('ApiClient\Bliskapaczka', 'ApiClient\Validator', $className);
