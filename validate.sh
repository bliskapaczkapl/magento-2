...
$VENDOR_DIR/bin/phpcs --exclude=PSR2.Methods.MethodDeclaration,PSR2.Classes.PropertyDeclaration --extensions=php --standard=PSR2 -s app/code/Sendit/Bliskapaczka/
$VENDOR_DIR/bin/phpmd app/code/Sendit/Bliskapaczka/ text codesize
$VENDOR_DIR/bin/phpcpd app/code/Sendit/Bliskapaczka/
